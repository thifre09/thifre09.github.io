...
const dialogos = {
    ...
    514: new Decisao([], "Eu sei que você seria util, mas eu não tenho espaço no PC", "Eu posso te ajudar a liberar espaço se esse é o problema"),
    524: new Decisao([], "Porque eu simplesmente não preciso de você, desculpa", "Mas eu prometo que vou ser util, tenho milhões de funcionalidades, pelo menos 1 deve servir para você"),
    534: new Decisao([], "Porque você é inutil", "Eu não sou inutil😠, eu tenho diversas funcionalidades e milhões de usuários"),
    515: new Decisao([], "Pedir desculpa? kkkkkk, claro que não sua coisa", "Eu estou te avisando... Essa é sua ultima chance para pedir desculpas"),
    ...
    621: new Decisao([], "Já sei como vo...", []), //final
