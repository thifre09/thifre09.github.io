...
let reviews = [
    new Review("A Hat in Time", "a hat in time.jpg", new Notas(6, 4, 6, 9, "", 2, 7, 6.5), "Achei um jogo bem superestimado"),
    new Review("Among Us", "among us.jpeg", new Notas(8, "N/A", 8.5, 9.5, "Não sei", "1-10", 10, 8), "Esse jogo só é divertido com amigos"),
    new Review("Animal Well", "animal well.jpg", new Notas(9, "Não sei", 8.5, 8, "", 4, 9.5, 9), "Eu não entendi nada da história, mas o jogo é muito divertido"),
    new Review("Astro's Playroom", "astro playroom.jpeg", new Notas(10, "N/A", 10, 9, "", 1, 10, 10), "É um jogo que parece simples, mas é extremamente divertido"),
    ...
    new Review("Bloodborne", "bloodborne.jpg", new Notas(8, 4, 6, 8, "", 7, 8, 9), "Foi meu primeiro soulslike, e as primeiras 10 horas foram ridiculamente difíceis, mas depois que você aprende os padrões dos inimigos, o jogo se torna muito divertido"),
    ...
    new Review("Carto", "carto.jpg", new Notas(8.5, 6.5, 8, 8, "", 2, 7, 8), "É legalzinho, mas é só isso mesmo"),
    new Review("Celeste", "celeste.jpg", new Notas(9, 5, 8.5, 8.5, "", 6, 8.5, 9), "Se você jogou celeste pela história, você é estranho"),
    ...
    new Review("Control", "control.jpg", new Notas(7, 4, 9, 7, "", 4, 6, 6.5), "Achei bem decepcionante, principalmente considerando que ele concorreu a jogo do ano. E eu não entendi absolutamente nada da história"),
    new Review("Death Stranding", "death stranding.jpg", new Notas(8.5, 9, 9.5, 10, "", 4, 8, 9), "O melhor simulador de carteiro de todos"),
    new Review("Demon's Souls", "demons souls.jpg", new Notas(8, 4, 9, 8, "", 6, 8, 8.5), "Para um soulslike, achei ele bem fácil. A história é bem confusa, como todo bom soulslike deve ser"),
    ...
    new Review("Doki Doki literature club plus", "doki doki.jpg", new Notas(2, 9.5, 9, 9, "", 1, 5, 8), "É definitivamente uma experiência única"),
    ...
    new Review("Ghost of Tsushima", "ghost of tsushima.jpeg", new Notas(9.5, 7, 9.5, 8, "", 3, 9.5, 9.5), "O combate é bem satisfatório quando você aprende a defender"),
    ...
    new Review("God of war 2018", "god of war 2018.jpeg", new Notas(9.5, 9.5, 9.5, 8.5, "", 4, 9.5, 10), "Esse jogo é fenomenal, a história é muito boa, o combate é muito satisfatório, e a trilha sonora é ótima. Ele é um dos meus jogos favoritos de todos os tempos"),
    new Review("God of War Ragnarok", "god of war ragnarok.jpg", new Notas(10, 9.5, 9.5, 8.5, "", 4, 9.5, 9.5), "Eu gostei bastante desse jogo, mas achei ele um pouco inferior ao God of War 2018"),
    ...
    new Review("Hollow Knight: Silksong", "silksong.jpg", new Notas(10, 8.5, 10, 9.5, "", 9, 10, 10), "Silksong é uma sequência perfeita, ele é melhor em quase todos os sentidos(mesmo que as notas não condizam com o que eu acabei de falar). O jogo é mais divertido, mais bonito e muito maior, mas os bosses do primeiro são melhores"),
    new Review("Horizon Forbidden West", "horizon forbidden west.jpeg", new Notas(9, 10, 9.5, 9.5, "", 5, 9.5, 9.5), "Esse jogo é lindo, tão bom quanto o primeiro"),
    new Review("Horizon Zero Dawn", "horizon zero dawn.jpeg", new Notas(9, 10, 9.5, 9.5, "", 5, 9.5, 9.5), "Esse jogo é magnifico, uma pena que eu joguei ele com 20FPS, com os gráficos no mínimo"),
    new Review("Kena: bridge of spirits", "kena bridge of spirits.jpg", new Notas(8, 7, 9.5, 8.5, "", 4, 8, 8.5), "O jogo é bem bonito, e a ultima dificuldade é muito difícil, ela quase me fez desistir da platina"),
    new Review("Life is Strange", "life is strange 1.jpeg", new Notas(8, 9, 7, 8, "", 1, 7.5, 8), "Voltar no tempo é bem legal"),
    new Review("Life is Strange 2", "life is strange 2.jpg", new Notas(2, 9, 7, 8, "", 1, 5, 5.5), "A melhor coisa do primeiro jogo era voltar no tempo, e o segundo jogo não tem isso. A única coisa que salva esse jogo de ser um lixo é a historia"),
    new Review("Minecraft", "minecraft.jpeg", new Notas(10, "N/A", 10, 10, "Não sei", 3, 10, 10), "Acho que não preciso explicar nada"),
    new Review("Ratchet and clank: Rift Apart", "ratchet and clank rift apart.jpg", new Notas(9, 8.5, 9.5, 8, "", 3, 9.5, 9), "O foguetão é bem roubado"),
    ...
    new Review("Sekiro", "sekiro.jpg", new Notas(9.5, 6, 6, 8.5, "", 9, 9.5, 9.5), "Hesitação é derrota. Genichiro Ashina é possivelmente o melhor boss da historia dos video games"),
    ...
    new Review("Spider-man 2", "spider man 2.jpg", new Notas(10, 7.5, 8.5, 8, "", 2, 10, 9.5), "O combate é melhor que o do primeiro"),
    new Review("Spider-man Miles Morales", "spider man miles morales.jpg", new Notas(10, 8, 8.5, 8, "", 2, 10, 9.5), "É mais legal jogar de Miles do que com o Peter"),
    new Review("Spider-man remastered", "spider man remastered.jpg", new Notas(9.5, 8, 8.5, 8, "", 2, 10, 9.5), "Que combate satisfatório, mas ele é muito fácil"),
    ...
    new Review("The Last of Us 1", "the last of us 1.jpg", new Notas(8.5, 9.5, 9.5, 9, "", 4, 9, 9.5), "A história é absoluto cinema"),
    new Review("The Last of Us 2", "the last of us 2.jpg", new Notas(8.5, 10, 9.5, 9.5, "", 4, 8.5, 9.5), "Também conhecido como simulador de depressão. No final do jogo eu estava chorando, e eu nem sabia o por quê"),
    new Review("The Plucky Squire", "the plucky squire.jpg", new Notas(8, 8.5, 9, 8, "", 2, 9, 8.5), "Sair do livro é bem legal, vai de 2D para 3D, simplesmente genial"),
    new Review("The Stanley Parable: Ultra Deluxe", "the stanley parable ultra deluxe.jpg", new Notas(2, 9.5, 8.5, 8.5, "", 1, 10, 8.5), "Esse é o melhor walking simulator que tem, ele é muito engraçado"),
];
