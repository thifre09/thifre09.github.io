...
let reviews: Review[] = [
    new Review("A Hat in Time", "a hat in time.jpg", new Notas(6, 4, 6, 9, "", 2, 7, 6.5)),
    ...
    new Review("Control", "control.jpg", new Notas(7, 4, 9, 7, "", 4, 6, 6.5)),
    new Review("Death Stranding", "death stranding.jpg", new Notas(8.5, 9, 9.5, 10, "", 4, 8, 9)),
    new Review("Demon's Souls", "demons souls.jpg", new Notas(8, 4, 9, 8, "", 6, 8, 8.5)),
    // new Review("Detroit: Become Human", "detroit.jpg", new Notas()),
    new Review("Dispatch", "dispatch.jpg", new Notas(8, 9, 9.5, 8, "8h", 1, 9, 8.5)),
    new Review("Doki Doki literature club plus", "doki doki.jpg", new Notas(2, 9.5, 9, 9, "", 1, 5, 8)),
    new Review("Fall guys", "fall guys.jpeg", new Notas(6, "N/A", 7, 8.5, "+12h", 5, 4, 5.5)),
    new Review("Forager", "forager.jpg", new Notas(8, "N/A", 9, 8, "Não sei", 2, 8.5, 8)),
    new Review("Fortnite", "fortnite.jpeg", new Notas(9.5, "N/A", 9.5, 9.5, "+4400h", "6-10", 9, 9.5)),
    new Review("Geometry Dash", "geometry dash.png", new Notas(9, "N/A", 8, 10, "Não sei", 7, 8.5, 8.5)),
    new Review("Ghost of Tsushima", "ghost of tsushima.jpeg", new Notas(9.5, 7, 9.5, 8, "", 3, 9.5, 9.5)),
    new Review("God of war 1", "god of war 1.jpeg", new Notas(8, 9, 9.5, 9.5, "Não sei", 4, 9, 9.5)),
    new Review("God of war 2", "god of war 2.jpeg", new Notas(8, 8, 9.5, 9.5, "Não sei", 4, 9, 8.5)),
    new Review("God of war 2018", "god of war 2018.jpeg", new Notas(9.5, 9.5, 9.5, 8.5, "", 4, 9.5, 10)),
    new Review("God of War Ragnarok", "god of war ragnarok.jpg", new Notas(10, 9.5, 9.5, 8.5, "", 4, 9.5, 9.5)),
    new Review("Hades", "hades.jpg", new Notas(9.5, 8.5, 9.5, 10, "Não sei", 4, 9.5, 9.5)),
    new Review("Hades 2", "hades 2.jpg", new Notas(9.5, 8.5, 9.5, 10, "Não sei", 4, 9, 9.5)),
    new Review("Hogwarts Legacy", "hogwarts legacy.jpeg", new Notas(10, 7, 9.5, 8, "71h", 2, 10, 9.5)),
    new Review("Hollow Knight", "hollow knight.jpeg", new Notas(10, 9, 10, 10, "+60h", 7, 10, 10)),
    new Review("Hollow Knight: Silksong", "silksong.jpg", new Notas(10, 8.5, 10, 9.5, "", 7, 10, 10)),
    new Review("Horizon Forbidden West", "horizon forbidden west.jpeg", new Notas(9, 10, 9.5, 9.5, "", 5, 9.5, 9.5)),
    new Review("Horizon Zero Dawn", "horizon zero dawn.jpeg", new Notas(9, 9.5, 9.5, 9.5, "", 5, 9.5, 9.5)),
    new Review("Kena: bridge of spirits", "kena bridge of spirits.jpg", new Notas(8, 7, 9.5, 8.5, "", 4, 8, 8.5)),
    new Review("Life is Strange", "life is strange 1.jpeg", new Notas(8, 9, 7, 8, "", 1, 7.5, 8)),
    new Review("Life is Strange 2", "life is strange 2.jpg", new Notas(2, 9, 7, 8, "", 1, 5, 5.5)),
    new Review("Minecraft", "minecraft.jpeg", new Notas(10, "N/A", 10, 10, "Não sei", 3, 10, 10)),
    new Review("Ratchet and clank: Rift Apart", "ratchet and clank rift apart.jpg", new Notas(9, 8.5, 9.5, 8, "", 3, 9.5, 9)),
    new Review("Red Dead Redemption 2", "red dead 2.jpeg", new Notas(9.5, 8.5, 10, 9, "72h", 3, 8, 9.5)),
    new Review("Sekiro", "sekiro.jpg", new Notas(9.5, 6, 6, 8.5, "", 9, 9.5, 9.5)),
    new Review("Shadow of the colossus", "shadow of the colossus.jpg", new Notas(7.5, 5, 9.5, 8.5, "", 2, 6, 7)),
    new Review("Spider-man 2", "spider man 2.jpg", new Notas(10, 7.5, 8.5, 8, "", 2, 10, 9.5)),
    new Review("Spider-man Miles Morales", "spider man miles morales.jpg", new Notas(10, 8, 8.5, 8, "", 2, 10, 9.5)),
    new Review("Spider-man remastered", "spider man remastered.jpg", new Notas(9.5, 8, 8.5, 8, "", 2, 10, 9.5)),
    new Review("Stumble guys", "stumble guys.jpeg", new Notas(7.5, "N/A", 7, 8.5, "Não sei", 5, 9.5, 8)),
    new Review("Superhot VR", "super hot.jpg", new Notas(9.5, "Não sei", 5, 8, "+8h", 3, 10, 9)),
    new Review("The Last of Us 1", "the last of us 1.jpg", new Notas(8.5, 9.5, 9.5, 9, "", 4, 9, 9.5)),
    new Review("The Last of Us 2", "the last of us 2.jpg", new Notas(8.5, 10, 9.5, 9.5, "", 4, 8.5, 9.5)),
    new Review("The Plucky Squire", "the plucky squire.jpg", new Notas(8, 8.5, 9, 8, "", 2, 9, 8.5)),
    new Review("The Stanley Parable: Ultra Deluxe", "the stanley parable ultra deluxe.jpg", new Notas(2, 9.5, 8.5, 8.5, "", 1, 10, 8.5)),
];
