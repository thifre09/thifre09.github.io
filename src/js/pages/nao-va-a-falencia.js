...
class Investimento {
    ...
    valorInvestido;
    historico;
    constructor(nome, valorAtual, variacao, min, max) {
        this.nome = nome;
...
class Propriedade {
    static investimento = new Investimento("Propriedade", 50, 0, 1, 100);
    nome;
    valorBase;
    rendaAnualBase;
    despestasAnuaisBase;
...
class Banco {
    ...
    maximoEmprestimo;
    maximoParcelas;
    constructor(nome, descricao, taxaJuros, maximoEmprestimo, maximoParcelas) {
        this.nome = nome;
        this.descricao = descricao;
...
class Emprestimo {
    ...
    numeroParcerlas;
    parcelasRestantes;
    constructor(valorInicial, banco, numeroParcerlas) {
...
class Pessoa {
    ...
    satisfacao;
    influencia;
    constructor(nome, descricao, satisfacao, influencia) {
        this.nome = nome;
        this.descricao = descricao;
...
function atualizarInvestimentosUI(investimentoIndex = 0) {
    ...
    `;
    const quantidadeAcoes = document.getElementById("quantidade-acoes");
...
function atualizarPropriedadesUI(propriedadeIndex = 0) {
...
function atualizarEmprestimosUI(bancoIndex = 0) {
    ...
    `;
    const valorInput = document.getElementById("valor-emprestimo");
    const parcelasInput = document.getElementById("parcelas-emprestimo");
...
function obterDadosFiltroSatisfacao(satisfacao) {
